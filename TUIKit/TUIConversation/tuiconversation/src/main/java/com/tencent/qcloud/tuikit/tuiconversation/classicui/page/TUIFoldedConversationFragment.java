...
public class TUIFoldedConversationFragment extends BaseFragment {
    ...
    private void initView() {
        ...
        mFoldedLayout.getConversationList().setOnConversationAdapterListener(new OnConversationAdapterListener() {
            ...
            @Override
            public void onItemLongClick(View view, int viewType, ConversationInfo conversationInfo) {
                showItemPopMenu(view, conversationInfo);
            }

            @Override
            public void onItemClickTop(View view, int viewType, ConversationInfo conversationInfo) {

            }

            @Override
            public void onItemClickDelete(View view, int viewType, ConversationInfo conversationInfo) {
